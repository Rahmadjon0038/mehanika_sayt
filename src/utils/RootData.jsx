...
import Nuqtaharakati41 from '../components/KinematikaBolim4/Nuqtaharakati41'
...
export const rootdata = [
    ...
    {
        id: 32,
        name: <Nuqtaharakati41 />,
        path: "/Nuqtaharakati41"
    },
    {
        id: 33,
        name: <NuqtaHarakatiKoordinatalarUsulida />,
        path: "/NuqtaHarakatiKoordinatalarUsulida"
    },

    {
        id: 34,
        name: <NuqtaharakatiTabitU43 />,
        path: "/NuqtaharakatiTabitU43"
    },
    {
        id: 35,
        name: <NuqtaharakatiMasalalar44 />,
